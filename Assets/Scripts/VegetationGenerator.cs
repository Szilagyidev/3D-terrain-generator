...
public class VegetationGenerator : MonoBehaviour
{
    ...
    [Header("Raycast Settings")] [SerializeField] int density;
    ...
    public void Generate(){
        ...
        for (int i = 0; i < density; i++)
        {
          ...
          instantiatedPrefab.transform.rotation = Quaternion.Lerp(transform.rotation, transform.rotation * Quaternion.FromToRotation(instantiatedPrefab.transform.up, hit.normal)
          , rotateTowardsNormal);
